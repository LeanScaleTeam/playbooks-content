...
1. **Top-Down Guidance (First Down):** Executive team provides strategic initiatives, growth goals, key metrics
2. **Bottom-Up Plan (First Up):** Functional teams create comprehensive plan including capacity model, CS carry model, marketing budget
3. **Executive Review (Second Down):** Leadership reviews, potentially adjusts assumptions based on bottom-up reality
4. **Final Bottom-Up Plan (Second Up):** Functional teams create updated plan aligned with refined guidance
5. **Final Approval:** Executive team approves comprehensive plan for implementation
...
1. Revenue target (anchor point)
2. Net retention effect on existing base
3. New business bookings required
4. Pipeline needed (at conversion rate)
5. SQLs needed (with sales cycle offset)
6. MQLs needed
7. Brand and awareness activities
...
[1] [Forecastio - Sales Capacity Planning: Strategic Guide for 2025](https://forecastio.ai/blog/sales-capacity-planning)

[2] [CaptivateIQ - Sales Capacity Planning Guide](https://www.captivateiq.com/blog/sales-capacity-planning)

[3] [Bureau of Labor Statistics - Business Employment Dynamics](https://www.bls.gov/bdm/)

[4] [CB Insights - The Venture Capital Funnel](https://www.cbinsights.com/research/venture-capital-funnel-2/)

[5] [CB Insights - Top Reasons Startups Fail](https://www.cbinsights.com/research/startup-failure-reasons-top/)

[6] [Demandbase - B2B Sales & Marketing Alignment](https://www.demandbase.com/blog/b2b-sales-marketing-alignment/)

[7] [Jifflenow - Sales and Marketing Alignment Statistics](https://www.jifflenow.com/blog/sales-and-marketing-alignment-statistics/)

[8] [Salesforce State of Sales Report](https://www.salesforce.com/resources/research-reports/state-of-sales/)

[9] [Gartner - FP&A Transformation Research](https://www.gartner.com/en/finance/role/financial-planning-analysis)

[10] [Scale Finance - The Venture Capital Secret](https://scalefinance.com/the-venture-capital-secret-75-of-startups-fail/)
